...
function course_search(){
  ...
  <div id="course-search" class="">
    ...
    <div class="section-filter">
      ...
      <!-- <div class="section-filter-second row">
        <h2>Nivå</h2>
        <div class="small-centered small-10 medium-10 large-8">
          <div class="columns small-12 medium-6 large-6">

            <div class="choise">
              <label for="level_1">Nybörjare</label>
              <input id="level_1" type="checkbox" name="level_1"><br>
            </div>
            <div class="choise">
              <label for="level_2">Fortsättning</label>
              <input id="level_2" type="checkbox" name="level_2"><br>
            </div>
            <div class="choise">
              <label for="level_3">Mellan</label>
              <input id="level_3" type="checkbox" name="level_3"><br>
            </div>
          </div>

          <div class="columns small-12 medium-6 large-6">
            <div class="choise">
              <label for="level_4">Avancerad</label>
              <input id="level_4" type="checkbox" name="level_4"><br>
            </div>
            <div class="choise">
              <label for="level_5">Proffesioonell</label>
              <input id="level_5" type="checkbox" name="level_5"><br>
            </div>
            <div class="choise">
              <label for="level_6">Ingen nivå</label>
              <input id="level_6" type="checkbox" name="level_6"><br>
            </div>
          </div>
        </div>
