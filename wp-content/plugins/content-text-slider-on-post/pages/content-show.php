  ...
  <div id="icon-edit" class="icon32 icon32-posts-post"></div>
	...
	<?php
      ...
      <table width="100%" class="widefat" id="straymanage">
        <thead>
          <tr>
			<th scope="col" style="width:220px;"><?php _e('Title', 'content-text-slider-on-post'); ?></th>
	  ...
	  <div class="tablenav">
	  <h2>
	  <a class="button add-new-h2" href="<?php echo WP_ctsop_ADMIN_URL; ?>&amp;ac=add"><?php _e('Add New', 'content-text-slider-on-post'); ?></a>
	  <a class="button add-new-h2" href="<?php echo WP_ctsop_ADMIN_URL; ?>&amp;ac=set"><?php _e('Plugin Setting', 'content-text-slider-on-post'); ?></a>
	  <a class="button add-new-h2" target="_blank" href="<?php echo WP_ctsop_FAV; ?>"><?php _e('Help', 'content-text-slider-on-post'); ?></a>
	  </h2>
	  </div>
	  <div style="height:5px"></div>
	<h3><?php _e('Plugin configuration option', 'content-text-slider-on-post'); ?></h3>
	<ol>
		<li><?php _e('Add the plugin in the posts or pages using short code.', 'content-text-slider-on-post'); ?></li>
		<li><?php _e('Add directly in to the theme using PHP code.', 'content-text-slider-on-post'); ?></li>
	</ol>
	<p class="description">
		<?php _e('Check official website for more information', 'content-text-slider-on-post'); ?>
		<a target="_blank" href="<?php echo WP_ctsop_FAV; ?>"><?php _e('click here', 'content-text-slider-on-post'); ?></a>
	</p>
	</div>
</div>