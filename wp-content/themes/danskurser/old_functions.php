...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
      ...
      //   wp_enqueue_script('modernizr'); // Enqueue it!
      //
      //   // wp_register_script('scripts', get_template_directory_uri() . '/js/scripts.js', array('jquery') ); // Custom scripts
...
function course_search(){
  ...
  <div id="course-search" class="">
    ...
    <form action="" method="get">
      ...
      <select id="city click-toggle" name="city">
    ...
    <div class="section-filter" id="open">
      ...
      <div class="section-filter-second toggle row" id="advanced-filter">
    ...
    <section class="section-result" id="open-result">
